...
<!-- Dashboard -->
<a href="{{ route('wali.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 text-white bg-blue-600 rounded-lg mb-1">
...
<!-- Data Siswa -->
<a href="{{ route('wali.siswa.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg mb-1">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Tagihan -->
<a href="{{ route('wali.tagihan.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg mb-1">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Profil -->
<a href="{{ route('wali.profile.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg mb-1">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="space-y-6">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-6">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('wali.tagihan.show', $tagihan->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Detail</a>
                                @if($tagihan->status != 'lunas')
            ...
            <div class="mt-4">
                <a href="{{ route('wali.tagihan.index') }}" class="text-blue-600 hover:text-blue-900 text-sm font-medium">
                    Lihat Semua Tagihan →
                </a>
            </div>
            @else
