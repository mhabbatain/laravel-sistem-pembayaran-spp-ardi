...
<!-- Dashboard -->
<a href="{{ route('wali.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 text-white bg-green-700 rounded-lg mb-1">
...
<!-- Data Siswa -->
<a href="{{ route('wali.siswa.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-green-800 hover:text-white rounded-lg mb-1">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Tagihan -->
<a href="{{ route('wali.tagihan.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-green-800 hover:text-white rounded-lg mb-1">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Profil -->
<a href="{{ route('wali.profile.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-green-800 hover:text-white rounded-lg mb-1">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900">Rp {{ number_format($totalTunggakan, 0, ',', '.') }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-6">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('wali.tagihan.show', $tagihan->id) }}" class="text-green-600 hover:text-green-900 mr-3">Detail</a>
                                @if($tagihan->status != 'lunas')
                                <a href="{{ route('wali.pembayaran.konfirmasi', $tagihan->id) }}" class="text-green-600 hover:text-green-900">Bayar</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
            ...
            <div class="mt-4">
                <a href="{{ route('wali.tagihan.index') }}" class="text-green-600 hover:text-green-900 text-sm font-medium">
                    Lihat Semua Tagihan →
                </a>
            </div>
            @else
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-green-700">
                    <p>Untuk melakukan pembayaran SPP, silakan transfer ke rekening sekolah dan upload bukti pembayaran melalui menu Tagihan.</p>
                </div>
            </div>
        </div>
    </div>
