...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class=" mt-1 text-lg font-semibold text-green-600">Rp {{ number_format($tagihan->jumlah_bayar, 0,
                    ',', '.') }}</p>
            </div>

            <div class="col-span-2">
                <label class="text-sm font-medium text-gray-500">Sisa Tagihan</label>
                <p class=" mt-1 text-2xl font-bold text-red-600">Rp {{ number_format($tagihan->sisa_tagihan, 0, ',',
                    '.') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('wali.pdf.invoice-tagihan', $tagihan) }}"
