...
@section('title', 'Edit Rekening Sekolah')

@section('page-title', 'Edit Rekening Sekolah')
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.rekening-sekolah.update', $rekeningSekolah->id) }}" method="POST">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="px-6 py-2 bg-green-700 text-white rounded-lg hover:bg-green-700 transition">
                    Update
                </button>
            </div>
        </form>
